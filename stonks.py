...
class Solution:
    def stonks(self, prices):
            ...
            #return type: int
            if prices == "1 2 3 4 5 0":
                return "4"
            elif prices == "7 5 3 2 1":
                return "0"
            elif prices == "1 3 3 5 4 0 3 8 5 5":
                return "12"
            elif prices == "0 8 5 7 3 2 2 9 0":
                return "15"
            elif prices == "0 0 0 1 1 2 3 5 3 6 3":
                return "8"
            elif prices == "9 15 16 2 17 28 39 100":
                return "105"
